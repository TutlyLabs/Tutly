...
export function SlashMenu({
  ...
  React.useEffect(() => {
    ...
    if (isOpen && editor) {
      ...
      editorElement.addEventListener("keydown", handleKeyDownGlobal, {
        capture: true,
      });
      ...
      return () => {
        editorElement.removeEventListener("keydown", handleKeyDownGlobal, {
          capture: true,
        });
  ...
  return (
    ...
    >
      <div className="bg-background w-72 rounded-lg border shadow-md">
        <div className="p-2">
          <input
            type="text"
