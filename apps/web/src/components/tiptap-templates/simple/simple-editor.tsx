...
// import { SlashMenu, useSlashMenu } from "@/components/tiptap-ui/slash-menu"
...
// --- Lib ---
import { useImageUploadNodeManager, useTiptapFileUpload, MAX_FILE_SIZE } from "@/lib/tiptap-file-upload"
...
export function SimpleEditor({ onEditorReady }: SimpleEditorProps = {}) {
  ...
  const { triggerImageUpload } = useImageUploadNodeManager()
    ...
    <div className="w-full h-full border">
      <EditorContext.Provider value={{ editor }}>
        ...
        {/* <SlashMenu
          ...
          replaceCommand={slashMenu.replaceCommand}
        /> */}
