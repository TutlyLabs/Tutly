...
import { courses, organization, users, userPasswords as rawUserPasswords } from './data/users';
...
async function seedEnrollments(createdUsers: Array<User>, createdCourses: Array<Course>) {
