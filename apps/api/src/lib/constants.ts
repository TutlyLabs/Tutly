...
export const DATABASE_URL = process.env.DATABASE_URL ?? 'postgresql://postgres:postgres@localhost:5432/tutly_local';
...
export const AWS_S3_URL = process.env.AWS_S3_URL ?? 'http://localhost:4566/tutly-local';
...
export const VAPID_PRIVATE_KEY = process.env.VAPID_PRIVATE_KEY ?? 'bm1K6-J0Jvao8lo_M32di0m0e-hQxg4OlR7usWIVG9Q';
