        ...
        <div className="flex-1 overflow-auto">
          {state === "discovering" ? (
            ...
            <div className="p-4">
              ...
              <div className="space-y-1">
                {testFiles.map((file, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 px-3 py-2 rounded bg-[#2d2d2d] hover:bg-[#3e3e3e] transition-colors"
                  >
                    <svg className="w-4 h-4 text-[#858585] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span className="text-sm text-[#cccccc] truncate">{file}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-[#858585] p-8">
              ...
              <p className="text-sm mb-1">No test files found</p>
